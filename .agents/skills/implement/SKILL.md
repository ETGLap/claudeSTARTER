...
2. Context — deliberately narrow: the spec, the AGENTS.md files (kit `.Codex/AGENTS.md` +
   project root), `.Codex/context/project-context.md`, and the spec's linked prior
